    ...
    : AudioProcessorEditor(p), processor(p)
{
    ...
    addAndMakeVisible (labelFeedback = new Label ("new label",
                                                  CharPointer_UTF8 ("Feedback (0 \xe2\x80\x93 0.95)")));
...
void BasicDelayAudioProcessorEditor::resized()
{
    ...
    sliderFeedback->setBounds (32, 120, 150, 24);
    labelDelayTime->setBounds (32, 64, 150, 24);
    labelFeedback->setBounds (32, 144, 150, 24);
...
<JUCER_COMPONENT documentType="Component" className="BasicDelayAudioProcessorEditor"
  ...
  <SLIDER name="delay time" id="338034135fd527f" memberName="sliderDelayTime"
          ...
          needsCallback="1"/>
  <SLIDER name="feedback" id="441e090a3410b9ea" memberName="sliderFeedback"
          virtualName="" explicitFocusOrder="0" pos="32 120 150 24" min="0"
          max="0.94999999999999995559" int="0" style="LinearHorizontal"
          textBoxPos="TextBoxLeft" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1" needsCallback="1"/>
  <LABEL name="new label" id="31927c0c188cbe73" memberName="labelDelayTime"
  ...
  <LABEL name="new label" id="2b4a980d852c0a95" memberName="labelFeedback"
         virtualName="" explicitFocusOrder="0" pos="32 144 150 24" edTextCol="ff000000"
